...
public class Perpustakaan {
    ...
    public static void main(String[] args) {
        ...
        try (PrintWriter writerBarang = new PrintWriter(new File("Barang.txt"));
            ...
            writerPeminjam.printf("|==============================================================================|%n");
            writerPeminjam.printf("| %-3s | %-15s | %-15s | %-6s | %-9s | %-12s |%n", "No", "Judul", "PTanggal", "Nama", "TglKembali", "JmlDipinjam");
            writerPeminjam.printf("|==============================================================================|%n");
            for (Peminjam minjam : tabelPeminjam) {
                writerPeminjam.printf("| %-3d | %-15s | %-15d | %-6s | %-9d | %-12d  |%n", l, minjam.getJUDUL(), minjam.getPTANGGAL(), minjam.getNAMA(), minjam.getTGLKEMBALI(), minjam.getJMLDIPINJAM());
